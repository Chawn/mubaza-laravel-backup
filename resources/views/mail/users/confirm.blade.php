...
@section('content')
    <table style="width: 100%;padding:25px;">
        <tr>
            ...
            <td width="75%">
                <h1 style="margin: 0px;color:#0096ff">ขอบคุณสำหรับการสมัครสมาชิก</h1>
        ...
        <tr>
            <td colspan="2" style="padding:25px;border-top: 1px solid #ddd;font-size:14px;">
                ...
                <p>เหลืออีกขั้นตอนเดียวเท่านั้น คลิกที่ลิงค์ <a
                            href="{{ action('UserController@getActivate', [$id, $token]) }}">{{ action('UserController@getActivate', [$id, $token]) }}</a>
                    เพื่อยืนยันการสมัครสมาชิก</p>
