			...
			<div class="box-body">
				    ...
				    <div class="row">
				        <div class="col-sm-6">
				            <h2 class="text-center">
				            	<small>จำนวนเงิน </small> 24,000 บาท
				            </h2>
				            <h1 class="text-center text-danger">จ่ายแล้ว</h1>
				        </div>
				        <div class="col-sm-6">
				            <ul class="list-group">
                ...
                <div class="row">
                	<div class="col-sm-6 col-sm-offset-6">
                		<div class="">
	                		<p class="lead text-success">ข้อมูลการโอนเงิน</p>
	                		<div class="table-responsive">
	                			<table class="table">
	                				<tbody>
	                					<tr>
	                						<th style="width:50%">วันที่โอนเงิน:</th>
	                						<td>{{ Carbon::now()->format('d/m/Y, h:i น.') }}</td>
	                					</tr>
	                					<tr>
	                						<th>โอนเข้าธนาคาร:</th>
	                						<td>กรุงไทย เลขที่ 11232451</td>
	                					</tr>
	                					<tr>
	                						<th>จากธนาคาร:</th>
	                						<td>กรุงไทย</td>
                ...
                <div class="row">
                	...
                	<div class="col-sm-6 text-right">
                		<a href="" class="btn btn-warning"  data-toggle="modal" data-target="#modal-profit-detail">
                			<i class="fa fa-pencil"></i> แก้ไขรายละเอียดการโอนเงิน</a>
                	</div>
                </div>
			</div>
		</div>
